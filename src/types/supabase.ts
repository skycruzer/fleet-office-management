...
// Simplified types for the new optimized views
export type DashboardMetrics = Tables<'dashboard_metrics'>
export type ExpiringCheck = Tables<'expiring_checks_optimized'>
export type PilotSummary = Tables<'pilot_summary_optimized'>

// Aviation-specific status types
export type CheckStatus = 'EXPIRED' | 'CRITICAL' | 'URGENT' | 'WARNING' | 'CURRENT' | 'NO_EXPIRY'
export type ComplianceStatus = 'compliant' | 'attention' | 'critical'
